        ...
        axios.get(`${API.homeMovieApi}&t__=${new Date().getTime()}`)
            .then((response)=>{
                ...
                if(arr==null){
                    ...
                    window.sessionStorage.setItem("HomeMovie",JSON.stringify(arr))
        ...
        axios.get(`${API.homeHostMovieApi}&t__=${new Date().getTime()}`)
            .then((response)=>{
                ...
                if(arr==null){
                    ...
                    window.sessionStorage.setItem("HomeMovieData1",JSON.stringify(arr))
                    var newArr=response.data.data.films.map((item)=>{
                        var obj={}
        ...
        axios.get(`${API.addressApi}?t__=${new Date().getTime()}`)
            .then((response)=>{
                ...
                if(arr==null){
                    ...
                    window.sessionStorage.setItem("address",JSON.stringify(arr))
                    var aArr=[]
                    var bArr=[]
                    var cArr=[]
                    var dArr=[]
